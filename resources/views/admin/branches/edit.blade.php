    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.branches.update", [$branch->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('civil_defense_license') ? 'is-invalid' : '' }}" type="text" name="civil_defense_license" id="civil_defense_license" value="{{ old('civil_defense_license', $branch->civil_defense_license) }}" required>
