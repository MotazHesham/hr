    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.branches.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mailbox') ? 'is-invalid' : '' }}" type="text" name="mailbox" id="mailbox" value="{{ old('mailbox', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('building_number') ? 'is-invalid' : '' }}" type="text" name="building_number" id="building_number" value="{{ old('building_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_number') ? 'is-invalid' : '' }}" type="text" name="unit_number" id="unit_number" value="{{ old('unit_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('neighborhood') ? 'is-invalid' : '' }}" type="text" name="neighborhood" id="neighborhood" value="{{ old('neighborhood', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('street_number') ? 'is-invalid' : '' }}" type="text" name="street_number" id="street_number" value="{{ old('street_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comrl_reg_num') ? 'is-invalid' : '' }}" type="text" name="comrl_reg_num" id="comrl_reg_num" value="{{ old('comrl_reg_num', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('comrl_reg_expiry') ? 'is-invalid' : '' }}" type="text" name="comrl_reg_expiry" id="comrl_reg_expiry" value="{{ old('comrl_reg_expiry') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('chamber_commerce_num') ? 'is-invalid' : '' }}" type="text" name="chamber_commerce_num" id="chamber_commerce_num" value="{{ old('chamber_commerce_num', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('chamber_commerce_expiry') ? 'is-invalid' : '' }}" type="text" name="chamber_commerce_expiry" id="chamber_commerce_expiry" value="{{ old('chamber_commerce_expiry') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('municipal_license_num') ? 'is-invalid' : '' }}" type="text" name="municipal_license_num" id="municipal_license_num" value="{{ old('municipal_license_num', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('municcipal_license_expiry') ? 'is-invalid' : '' }}" type="text" name="municcipal_license_expiry" id="municcipal_license_expiry" value="{{ old('municcipal_license_expiry') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('civil_defense_license') ? 'is-invalid' : '' }}" type="text" name="civil_defense_license" id="civil_defense_license" value="{{ old('civil_defense_license') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('civil_defense_license_expiry') ? 'is-invalid' : '' }}" type="text" name="civil_defense_license_expiry" id="civil_defense_license_expiry" value="{{ old('civil_defense_license_expiry') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facility_num_in_work_office') ? 'is-invalid' : '' }}" type="text" name="facility_num_in_work_office" id="facility_num_in_work_office" value="{{ old('facility_num_in_work_office', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facility_num_in_insurance') ? 'is-invalid' : '' }}" type="text" name="facility_num_in_insurance" id="facility_num_in_insurance" value="{{ old('facility_num_in_insurance', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_num') ? 'is-invalid' : '' }}" type="text" name="tax_num" id="tax_num" value="{{ old('tax_num', '') }}" required>
