        ...
        <form method="POST" action="{{ route("admin.facilities.store") }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('civil_defense_license') ? 'is-invalid' : '' }}" type="text" name="civil_defense_license" id="civil_defense_license" value="{{ old('civil_defense_license') }}" required>
